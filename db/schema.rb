...
ActiveRecord::Schema.define(version: 2023_04_19_033818) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string "payment_method", default: "CashOnDelievery"
  ...
  add_foreign_key "ordered_items", "instruments"
